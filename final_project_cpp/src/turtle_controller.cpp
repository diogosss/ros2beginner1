...
//ros2 component load /ComponentManager final_project_cpp final_project::TurtleController -p turtle_name:=abc
//  RESP-> Loaded component 1 into '/ComponentManager' container node as '/turtle_controller'
//ros2 lifecycle nodes
//  RESP->/turtle_controller
//ros2 component list
//  RESP->/ComponentManager
//  RESP-> 1  /turtle_controller
//ros2 lifecycle set /turtle_controller configure
//ros2 lifecycle set /turtle_controller activate

//abriir otro componetne junto al primero con node name y otro turtle name
//ros2 component load /ComponentManager final_project_cpp final_project::TurtleController -r __node:=turtle_controller2 -p turtle_name:=feg
//ros2 lifecycle nodes
// ros2 lifecycle nodes
//  RESP-> /turtle_controller
//  RESP-> /turtle_controller2
