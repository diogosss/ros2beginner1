...
{
public:
    MoveRobotServerNode() : LifecycleNode("number_publisher")
    {
...
//  # Levantar robot A
//  # ros2 run lifecycle_cpp move_robot_server --ros-args -r __node:=move_robot_server_a -p robot_name:=A
...
//  # Levantar robot B
//  # ros2 run lifecycle_cpp move_robot_server --ros-args -r __node:=move_robot_server_b -p robot_name:=B
//  # Pasar estado configure
//  #  ros2 lifecycle set /move_robot_server_b configure
//  # Activar 
//  # ros2 lifecycle set /move_robot_server_b activate

//Test sin node manager
//ros2 action send_goal /move_robot_A my_robot_interfaces/action/MoveRobot "{position: 70, velocity: 3}"
